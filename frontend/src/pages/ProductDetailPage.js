...
const ProductCard = ({ product }) => (
  ...
  >
    ...
    <VStack align="start" spacing={1}>
      ...
      <HStack spacing={1}>
        <Text fontSize="xs" color="green.600" fontWeight="700">Supplied & Fitted</Text>
      </HStack>
    </VStack>
  </MotionBox>
);
...
export default function ProductDetailPage() {
    ...
    return (
      <Center minH="100vh">
        <VStack spacing={4}>
          ...
          <Text fontWeight="bold" color="gray.500">Loading premium part details...</Text>
        </VStack>
      </Center>
    );
  }
  ...
  if (error || !product) {
    return (
      <Center minH="100vh">
        <VStack spacing={4}>
          <Heading size="lg" color="red.500">Oops! Product Not Found</Heading>
          <Text color="gray.500">We couldn't find the engine you're looking for.</Text>
          <Button as={Link} to="/" colorScheme="brand" variant="outline">Return Home</Button>
        </VStack>
      </Center>
    );
  }

  const vatAmount = (product.pricingBreakdown?.item + product.pricingBreakdown?.delivery) * (product.pricingBreakdown?.vatRate || 0.20);
  const totalAmount = product.pricingBreakdown?.item + product.pricingBreakdown?.delivery + vatAmount;
        ...
        <Container maxW="container.xl">
          <HStack justify="space-between" align="center">
            <HStack spacing={3}>
              ...
              <HStack spacing={2}>
                <Text fontSize="xs" fontWeight="800" color="gray.700">{product.seller?.name}</Text>
                <Badge colorScheme="green" fontSize="9px" variant="solid" borderRadius="sm">{product.seller?.rating}</Badge>
              </HStack>
            </HStack>
            <Breadcrumb
              spacing="8px"
            ...
            <VStack spacing={12} align="stretch">
              ...
              <VStack align="start" spacing={5}>
                ...
                <HStack spacing={8}>
                  <VStack align="start" spacing={0}>
                    ...
                    <Text fontSize="xs" color="gray.400" fontWeight="bold">EXCLUSIVE OF VAT</Text>
                  </VStack>
                  <Divider orientation="vertical" h="40px" />
                  <HStack spacing={4}>
                    <VStack align="start" spacing={0}>
                      <Text fontSize="xs" color="gray.400" fontWeight="bold">CONDITION</Text>
                      <Text fontWeight="800" fontSize="sm">{product.condition}</Text>
                    </VStack>
                    <VStack align="start" spacing={0}>
              ...
              <Box>
                <HStack justify="space-between" mb={6}>
                  <Heading fontSize="xl" fontWeight="900">People also Search</Heading>
                  <HStack spacing={2}>
                    <Button size="xs" variant="ghost" borderRadius="full" isDisabled><FaArrowLeft /></Button>
                    <Button size="xs" variant="ghost" borderRadius="full" isDisabled><FaArrowRight /></Button>
                  </HStack>
                </HStack>
                <HStack spacing={6} overflowX="auto" pb={6} css={{ '&::-webkit-scrollbar': { display: 'none' } }}>
              ...
              <VStack align="start" spacing={16}>
                {/* Description */}
                <Box w="full">
                  <Heading fontSize="2xl" fontWeight="900" mb={6} color="gray.800">Complete Description</Heading>
                ...
                <Box w="full">
                  <Heading fontSize="2xl" fontWeight="900" mb={8} color="gray.800">Vehicle Compatibility Guide</Heading>
                  <Box overflowX="auto" borderRadius="2xl" border="1px solid" borderColor="gray.100" boxShadow="sm">
                    <Table variant="simple" size="md">
                      <Thead bg="gray.50">
                        <Tr>
                          <Th color="gray.400" fontSize="xs">Make</Th>
                          <Th color="gray.400" fontSize="xs">Model</Th>
                          <Th color="gray.400" fontSize="xs">Variant</Th>
                          <Th color="gray.400" fontSize="xs">Year</Th>
                          <Th color="gray.400" fontSize="xs">Engine Detail</Th>
                        </Tr>
                      </Thead>
                      <Tbody>
                        {product.compatibility?.map((item, idx) => (
                          <Tr key={idx} _hover={{ bg: "blue.50" }} transition="0.2s">
                            <Td fontWeight="900" color="gray.800">{item.make}</Td>
                ...
                <Box w="full" bg="gray.50" p={10} borderRadius="3xl">
                  <Heading fontSize="2xl" fontWeight="900" mb={10} textAlign="center">Estimate Pricing Breakdown</Heading>
                  <Grid templateColumns={{ base: "1fr", lg: "1.2fr 1fr" }} gap={12}>
                    <VStack align="stretch" spacing={4} bg="white" p={8} borderRadius="2xl" boxShadow="sm">
                      <Flex justify="space-between" pb={4} borderBottom="1px dashed" borderColor="gray.200">
                        <Text fontWeight="800">Exchange Engine</Text>
                        <Text fontWeight="800">£{product.pricingBreakdown?.item?.toLocaleString()}.00</Text>
                      </Flex>
                      <Flex justify="space-between" pb={4} borderBottom="1px dashed" borderColor="gray.200">
                        <Text fontWeight="800">Standard Delivery</Text>
                        <Text fontWeight="800">£{product.pricingBreakdown?.delivery?.toLocaleString()}.00</Text>
                      </Flex>
                      <VStack align="start" spacing={3} pt={4} color="gray.500" fontSize="sm">
                        <HStack><Icon as={FaInfoCircle} /><Text>Based on engine mileage from listing</Text></HStack>
                    ...
                    <VStack align="stretch" spacing={6}>
                      <Box>
                        ...
                        <Divider my={4} />
                        <PriceRow label="Total Amount" value={totalAmount?.toLocaleString()} isTotal />
                      </Box>
                      <Button colorScheme="brand" h="65px" fontSize="lg" borderRadius="2xl" boxShadow="0 10px 20px -5px rgba(21, 101, 192, 0.4)">
                        Request Fresh Quote
                      </Button>
                    </VStack>
                  </Grid>
              ...
              <VStack spacing={8} align="stretch">
                ...
                <Box p={8} borderRadius="2xl" border="1px solid" borderColor="gray.100" bg="white" boxShadow="sm">
                  <VStack align="start" spacing={6}>
                    <HStack spacing={4}>
                      ...
                      <VStack align="start" spacing={0}>
                        <Text fontSize="sm" fontWeight="900">National Shipping</Text>
                        <Text fontSize="xs" color="gray.500">Available anywhere in the UK</Text>
                      </VStack>
                    </HStack>
                    <HStack spacing={4}>
                      <Icon as={FaStar} color="orange.400" boxSize={6} />
                      <VStack align="start" spacing={0}>
                        <Text fontSize="sm" fontWeight="900">Trending Item</Text>
                        <Text fontSize="xs" color="gray.500">Popular view item this week</Text>
                      </VStack>
                    </HStack>
                    <HStack spacing={4}>
                      <Icon as={FaUndo} color="purple.500" boxSize={6} />
                      <VStack align="start" spacing={0}>
                        <Text fontSize="sm" fontWeight="900">Vehicle Recovery</Text>
                        <Text fontSize="xs" color="gray.500">Pick-up and drop-off offered</Text>
                      </VStack>
                    </HStack>
                  </VStack>
                </Box>
                ...
                <VStack align="stretch" spacing={3} px={4}>
                  <Flex justify="space-between">
                    <Text fontSize="xs" color="gray.400" fontWeight="bold">LOCATION</Text>
                    <Text fontSize="xs" fontWeight="900">{product.shipping?.location}</Text>
                  </Flex>
                  <Flex justify="space-between">
                    <Text fontSize="xs" color="gray.400" fontWeight="bold">DELIVERY</Text>
                    <Text fontSize="xs" fontWeight="900">{product.shipping?.delivery}</Text>
                  </Flex>
                  <Flex justify="space-between">
