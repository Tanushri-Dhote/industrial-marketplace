...
export default function BlogPage() {
	...
	const { data, isLoading, isError } = useQuery({
		...
		queryFn: () => fetchBlogs(currentPage, selectedCategory),
	...
	return (
		<Box bg="white" minH="100vh">
			...
			<Box bg="#0F172A" pt={20} pb={32} position="relative" overflow="hidden">
				<Box
					position="absolute"
					inset={0}
					...
					<VStack align="center" spacing={6} textAlign="center">
						...
						>
							...
							<BreadcrumbItem isCurrentPage>
								<BreadcrumbLink color={accentColor} fontWeight="bold">
									Blog
								</BreadcrumbLink>
							</BreadcrumbItem>
						</Breadcrumb>
						...
						<Text color="gray.400" fontSize="xl" maxW="700px" lineHeight="tall">
							Your definitive resource for engine maintenance, gearbox troubleshooting, and
							high-performance industrial equipment guides.
						</Text>
