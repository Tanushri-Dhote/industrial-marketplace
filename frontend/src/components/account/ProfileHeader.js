      ...
      <Flex direction={{ base: "column", md: "row" }} align="center" gap={8}>
        ...
        <VStack align={{ base: "center", md: "flex-start" }} spacing={2}>
          <HStack>
            ...
            <Badge colorScheme="blue" variant="subtle" borderRadius="full" px={3} fontSize="12px" fontWeight="800">
              TENANT ADMIN
            </Badge>
          ...
          <Text fontSize="18px" color="gray.500" fontWeight="600">
            {user?.businessName || "Global Industrial Solutions"}
          </Text>

          <Flex gap={6} pt={2} wrap="wrap">
            <HStack spacing={2} color="gray.400">
              <Icon as={FiMail} />
              <Text fontSize="14px" fontWeight="600">{user?.email || "admin@globalindustrial.com"}</Text>
            </HStack>
            <HStack spacing={2} color="gray.400">
              <Icon as={FiPhone} />
              <Text fontSize="14px" fontWeight="600">{user?.phone || "+44 20 7946 0958"}</Text>
            </HStack>
            <HStack spacing={2} color="gray.400">
              <Icon as={FiBriefcase} />
              <Text fontSize="14px" fontWeight="600">Owner / Manager</Text>
            </HStack>
          </Flex>
        </VStack>
      </Flex>
