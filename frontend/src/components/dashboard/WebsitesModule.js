...
import {
  ...
  useDisclosure, Badge, Box, VStack, Text, Icon,
  Select, Spinner, Center, Textarea,
      ...
      {isLoading ? (
        <Center py={16}>
          <VStack spacing={3}>
            ...
            <Text color="gray.500" fontSize="14px">Loading sites...</Text>
          </VStack>
        </Center>
      ) : websites.length === 0 ? (
        <Center py={16}>
          <VStack spacing={3}>
            ...
            <Text color="gray.500" fontWeight="600">No sites found</Text>
            <Text color="gray.400" fontSize="13px">Create your first tenant site to get started</Text>
          </VStack>
        </Center>
      ) : (
        <Box overflowX="auto">
...
function WebsiteModal({ isOpen, onClose, onSave, website }) {
  ...
  useEffect(() => {
    setFormData(website
      ? { name: website.name, domain: website.domain || '', description: website.description || '', status: website.status || 'active' }
        ...
        <ModalBody p={8}>
          <VStack spacing={5} align="stretch">
            <FormControl isRequired>
              <FormLabel fontSize="12px" fontWeight="700" color="gray.600">SITE NAME</FormLabel>
              <Input
                value={formData.name}
            ...
            <FormControl>
              <FormLabel fontSize="12px" fontWeight="700" color="gray.600">DOMAIN</FormLabel>
              <Input
            ...
            <FormControl>
              ...
              <Textarea
                ...
                borderRadius="xl" fontSize="14px" rows={3}
                _focus={{ borderColor: '#D90404', boxShadow: '0 0 0 3px rgba(217,4,4,0.1)' }}
              />
            </FormControl>
            <FormControl>
